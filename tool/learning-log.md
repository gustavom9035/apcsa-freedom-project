...
### 09/30/24 - 10/21/24 ("Passonate Preperation Zone"):
* In order to get this whole thing running you'll need the Sonic CD [decompilation](https://github.com/RSDKModding/RSDKv3-Decompilation).
  ...
  * As well make sure to follow the setting up the mods part! Use "MegAmi's Additons" as a test of sorts.
...
* Hopefully now you've gotten both working and running properly as now its time to connect the two!
  ...
  * Click on options and select game manager. Here you'll be greeted with different RSDK version but all you need to do is click on RSDKv3. Now i'll ask for you to put the .exe and data folder location for Sonic CD.
